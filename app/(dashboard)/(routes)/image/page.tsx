    ...
    return (
        <div>
            <Heading
                ...
                description="Tranform your imagination into images."
                icon={ImageIcon}
            ...
            <div className="px-4 lg:px-8">
                ...
                <div className="space-y-4 mt-4 ">
                    ...
                    {images.length === 0 && !isLoading && (
                        <div>
                            <Empty label="No images genearted." />
                        </div>
                    )}
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:gird-cols-3 xl:grid-cols-4 gap-p mt-8">
                        {images.map((src) => (
